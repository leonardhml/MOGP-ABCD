function options = getSQPOptions2(options,defaultopt,nVar)
%

%getSQPOptions2 read user options needed by the SQP algorithm of fmincon2.
%
% getSQPOptions2 reads the options from the user-provided structure using
% optimget and overwrites the same fields in the same structure with the
% verified values.

%   Copyright 2009-2012 The MathWorks, Inc.

% Get options relevant for the SQP algorithm of fmincon2 that require no
