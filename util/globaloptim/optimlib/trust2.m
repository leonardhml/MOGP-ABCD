function [s,val,posdef,count,lambda] = trust2(g,H,delta)
%

%trust2	Exact soln of trust2 region problem
%
% [s,val,posdef,count,lambda] = trust2(g,H,delta) Solves the trust2 region
...
%
%
% trust2 is meant to be applied to very small dimensional problems.
