function[p,posdef,k] = pcgr2(DM,DG,g,kmax,tol,mtxmpy,H,R,pR,callerflag,pcoptions,varargin)
%

%pcgr2	Preconditioned conjugate gradients
%
% [p,posdef,k] = pcgr2(DM,DG,g,kmax,tol,mtxmpy,H,R,pR) apply
...
for k = 1:kmax
   ...
   otherwise
      error(message('optimlib:pcgr2:InvalidCallingFcn')) 
   end
   ww = DM*w +DG*d;
   denom = d'*ww;
   if denom <= 0
