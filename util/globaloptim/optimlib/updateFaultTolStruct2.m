function faultTolStruct = updateFaultTolStruct2(faultTolStruct, ...
    newObjVal, updateUndefValue)
%

%updateFaultTolStruct2 Update fault tolerance structure
%
...
%   (e.g. levenbergMarquardt2) or trying one point per iteration (e.g.
...
%
%   faultTolStruct = updateFaultTolStruct2(faultTolStruct, newObjVal,
