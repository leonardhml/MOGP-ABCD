function [x, flag]  = feasibl2(A,bvec,xstart,R,p,RP,pp,D,tol)
%feasibl2 Find nearest feasible point.
%	 x  = feasibl2(A,bvec,xstart,R,p,RP,pp,D,tol) determines
...
ttol = 1e-12;
if nargin < 2
   error(message('optim:feasibl2:NotEnoughInputs'))
end
[t,n] = size(A);
if ~issparse(A)
   A=sparse(A);
