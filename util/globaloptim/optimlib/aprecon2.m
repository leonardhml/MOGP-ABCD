function[RPCMTX,ppvec] = aprecon2(A,upperbandw,DM,DG,varargin)
%

%aprecon2 Banded preconditioner function for least-squares problems.
%
%   [RPCMTX,PPVEC] = aprecon2(A,UPPERBW,DM,DG) produces the sparse
...
%   Default preconditioner for SLLSBOX and snls2.
...
elseif (upperbandw > 0) && (upperbandw < n-1) % Band approximation.
   ...
   error(message('optimlib:aprecon2:InvalidUpperbandw'));
end
