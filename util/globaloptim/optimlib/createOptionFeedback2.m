function optionFeedback = createOptionFeedback2(options)
%

%createOptionFeedback2 check if options are default and create structure used
...
% createExitMsg2 to give feedback to the user on whether the options that
...
stopTestOptions = {'TolFunValue','TolFun','TolX','TolCon','MaxIter','MaxFunEvals','MaxSQPIter','ObjectiveLimit'};
...
if isempty(options.TolFunValue)
