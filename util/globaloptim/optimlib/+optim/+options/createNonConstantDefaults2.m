function OS = createNonConstantDefaults2(OS)
%

%createNonConstantDefaults2 Create the NonConstantDefaults structure
%
%   OS = createNonConstantDefaults2(OS) creates the non-constant defaults
...
%   that option has a constant default or not. For example, for fmincon2,
%   OS.IsConstantDefault.TolX = false indicates that TolX does not have a
%   constant default for fmincon2.
%
