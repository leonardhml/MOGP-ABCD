function [summaryMsg,defaultMsg,delimiter,detailedMsg,detailsTable] = optimExitMsgParts2(exitMsg)
%

%optimExitMsgParts2 split exit messages from Optimization Toolbox solvers.
%
...
% - The default message body (e.g. "fmincon2 stopped because...")
