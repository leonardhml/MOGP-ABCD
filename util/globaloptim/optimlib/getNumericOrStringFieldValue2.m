function [fieldValue,ME] = getNumericOrStringFieldValue2(fieldName, ...
    allowedString,equivNumValue,dataTypeWithArticleForErrMsg,options,defaultopt)
%

%getNumericOrStringFieldValue2 reads in field value from options structure.
...
if ischar(fieldValue)
    if strcmpi(fieldValue,allowedString)
        ...
        errId = ['optimlib:getNumericOrStringFieldValue2:Invalid' fieldName 'Option'];
