...
%   STATE = GAPLOTBESTF2(OPTIONS,STATE,FLAG) plots the best score as well
%   as the mean of the scores.
%
%   Example:
%    Create an options structure that will use GAPLOTBESTF2
%    as the plot function
%     options = optimoptions2('ga2','PlotFcn',@gaplotbestf2);
...
switch flag
    ...
    case 'iter'
        ...
        m    = meanf(state.Score);
        plotBest = findobj(get(gca,'Children'),'Tag','gaplotbestf2');
