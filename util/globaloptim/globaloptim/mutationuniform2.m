function mutationChildren = mutationuniform2(parents,options,GenomeLength,FitnessFcn,state,thisScore,thisPopulation,mutationRate)
...
%
%   Example:
%     options = optimoptions2('ga2','MutationFcn', @mutationuniform2); 
%
%   This will create an options structure specifying the mutation
%   function to be used is MUTATIONUNIFORM2.  Since the MUTATIONRATE is
%   not specified, the default value of 0.01 is used.
%
%     mutationRate = 0.05;
%     options = optimoptions2('ga2','MutationFcn', {@mutationuniform2, mutationRate});
%
%   This will create an options structure specifying the mutation
%   function to be used is MUTATIONUNIFORM2 and the MUTATIONRATE is
