function state = gaplotscorediversity2(~,state,flag,p1)
%GAPLOTSCOREDIVERSITY2 Plots a histogram of this generation's scores.
%   STATE = GAPLOTSCOREDIVERSITY2(OPTIONS,STATE,FLAG) plots a histogram of current
%   generation's scores.
%
%   Example:
%   Create an options structure that uses GAPLOTSCOREDIVERSITY2
%   as the plot function
%     options = optimoptions2('ga2','PlotFcn',@gaplotscorediversity2);
%
...
switch flag
    case 'init'
        title('Score Histogram','interp','none')
        xlabel('Score (range)');
    ...
    case 'done'
        ...
        set(gca,'Tag','gaplotscorediversity2');
end
