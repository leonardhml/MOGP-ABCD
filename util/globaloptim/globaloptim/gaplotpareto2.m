...
%GAPLOTPARETO2 Plots a Pareto front for first two objectives.
%
%   Example:
%    Create an options structure that will use GAPLOTPARETO2
%    as the plot function
%     options = optimoptions2('gamultiobj2','PlotFcn',@gaplotpareto2);
...
try
    ...
    if strcmpi(flag,'init')
        warning(message('globaloptim:gaplotpareto2:invalidObjectivesToPlot'));
    end
end
