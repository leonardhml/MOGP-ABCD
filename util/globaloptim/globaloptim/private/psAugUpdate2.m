function [psAugParam,optimState] = psAugUpdate2(Iterate,psAugParam,optimState,options, ...
        numNonlinIneqcstr,numNonlinCstr)
%PSAUGUPDATE2 Updates values of parameters for augmented Lagrangian PS 
