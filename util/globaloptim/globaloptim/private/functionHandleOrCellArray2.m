function [FUN,ARGS] = functionHandleOrCellArray2(property,value)
%functionHandleOrCellArray2 A function Handle or a cell array starting with a
%   function handle.
...
for i = 1:numel(value)
    ...
    if(~isempty(handle)) && (isa(handle,'inline') || isa(handle,'function_handle'))
        ...
        error(message('globaloptim:functionhandleorcellarray2:needFunctionHandle', property));
    end
end
