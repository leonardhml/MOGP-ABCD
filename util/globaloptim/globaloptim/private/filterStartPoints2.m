function [startPointsToRun, numFunEvals] = ...
    filterStartPoints2(RunStartPoints,startPointsToRun,problem,numNlinIneqCon)
%filterStartPoints2 Filter the supplied start points.
%
%   [FILTPTS, NUMFUNEVALS] = filterStartPoints2(RUNSTARTPTS, PTS, PROBLEM,
...
try
    ...
    c = nonlcon(x);
    if ~isreal(c)
        error(message('globaloptim:filterStartPoints2:UsrNonlConstrUndefAtX0'));
    end
catch ME
