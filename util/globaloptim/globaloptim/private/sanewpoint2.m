function solverData = sanewpoint2(solverData,problem,options)
%SANEWPOINT2 is used to generate the next point in the algorithm.  It
...
try
    ...
    gads_ME = MException('globaloptim:sanewpoint2:invalidAcceptanceFcn', ...
        'Failure in AnnealingFcn evaluation.');
    userFcn_ME = addCause(userFcn_ME,gads_ME);
    rethrow(userFcn_ME)
end
