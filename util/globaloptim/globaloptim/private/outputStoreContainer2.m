function fHdls = outputStoreContainer2
%OUTPUTSTORECONTAINER2 Container to store output information from a local
%solver.
%
%   FHDLS = OUTPUTSTORECONTAINER2 creates a structure of nested function
