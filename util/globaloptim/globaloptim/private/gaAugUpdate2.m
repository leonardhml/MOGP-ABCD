function [gaAugParam,state] = gaAugUpdate2(Iterate,gaAugParam,state,options,numNonlinIneqcstr,numNonlinCstr)
%GAAUGUPDATE2 Updates values of parameters for augmented Lagrangian GA2 
%   Private to GA2
