function nondominatedRank2 = nonDominatedRank2(score,nParent)
%nonDominatedRank2 Assigns rank to individuals in 'score'. 
...
nondominatedRank2 = inf(popSize,1);
...
rankCounter = 1;
while ~all(rankedIndiv) && nnz(isfinite(nondominatedRank2)) <= nParent
    dominates = all(dominationMatrix);
    nondominatedRank2(dominates) = rankCounter;
