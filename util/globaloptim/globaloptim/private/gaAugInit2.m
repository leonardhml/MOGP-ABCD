function [gaAugParam,numNonlinIneqcstr,numNonlinEqcstr,numNonlinCstr] = gaAugInit2(Iterate,options)
%GAAUGINIT2 Initial values of parameters for augmented Lagrangian GA2 
%   Private to GA2
...
penalty = gaoptimget2(options,'InitialPenalty',gaoptimset2,'fast');
