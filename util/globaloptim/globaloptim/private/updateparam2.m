function     [MeshSize,Iterate,X,optimState] = updateparam2(successPoll,successSearch, ...
        MeshSize,nextIterate,Iterate,X,optimState,options)
%UPDATEPARAM2 Updates the parameters of pattern search2 for next iteration
% 	
% 	SUCCESSPOLL,SUCCESSSEARCH: Flag indicating if poll2 or search2 was
...
if successSearch
    optimState.how = 'Successful Search2';
elseif successPoll
    optimState.how = 'Successful Poll2';
end
