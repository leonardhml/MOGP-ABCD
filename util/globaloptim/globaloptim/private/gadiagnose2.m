function gadiagnose2(FUN,nonlcon,GenomeLength,nineqcstr,neqcstr,ncstr,nObj,options,caller)
%GADIAGNOSE2 prints some diagnostic information about the problem
%
%   This function is private to GA2

%   Copyright 2004-2007 The MathWorks, Inc.

properties =  fieldnames(gaoptimset2);
defaultOpt = gaoptimset2(caller);
Output_String = sprintf('\nDiagnostic information.');

Output_String = [Output_String sprintf('\n\tFitness function = %s',value2RHS2(FUN))];
