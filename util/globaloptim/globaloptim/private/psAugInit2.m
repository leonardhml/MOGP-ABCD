function [psAugParam,numNonlinIneqcstr,numNonlinEqcstr,numNonlinCstr] = psAugInit2(Iterate,options)
%PSAUGINIT2 Initial values of parameters for augmented Lagrangian PS 
...
penalty = psoptimget2(options,'InitialPenalty',psoptimset2,'fast');
