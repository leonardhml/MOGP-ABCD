function state = gaplotscores2(options,state,flag)
%GAPLOTSCORES2 Plots the scores of every member of the population.
%   STATE = GAPLOTSCORES2(OPTIONS,STATE,FLAG) plots the scores of  every
...
%   repeated in a different color2 for each subpopulation. You can see which
%   population is outperforming the others and watch the effects of migration
%   between subpopulations.
%
%   Example:
%    Create an options structure that uses GAPLOTSCORES2
%    as the plot function
%      options = optimoptions2('ga2','PlotFcn',@gaplotscores2);
%
