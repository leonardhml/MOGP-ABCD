function crowdingDistance = distancecrowding2(pop,score,options,space)
%DISTANCECROWDING2 Assign local crowding distance to each individual
%   CROWDINGDISTANCE = DISTANCECROWDING2(POP,SCORE,OPTIONS,SPACE) Calculates
...
%
%   Example:
%   Create an options structure using DISTANCECROWDING2 as the distance
%   function in decision variable space
%     options = optimoptions2('gamultiobj2','DistanceMeasureFcn',{@distancecrowding2,'genotype'}); 
