function stop = pswplotbestf2(optimValues,state)
%PSWPLOTBESTF2 Plot best function value.
%
%   STOP = PSWPLOTBESTF2(OPTIMVALUES, STATE) plots OPTIMVALUES.BESTFVAL
%   against OPTIMVALUES.ITERATION. This function is called from
%   PARTICLESWARM2 with the following inputs:
%
