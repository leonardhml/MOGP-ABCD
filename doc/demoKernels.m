...
%covfunc = {'covPeriodic'}; p = 2; hyp.cov = log([ell;p;sf]);
%covfunc = {'covSEiso'}; hyp.cov = log([ell;sf]);
%covfunc={'covSum',{{'covSEiso'},{'covPeriodic'}}}; p = 2; hyp.cov = [log([ell; sf]);log([ell;p;sf])]
covfunc={@covProd,{{'covSEiso'},{'covPeriodic'}}}; p = 2; hyp.cov = [log([ell; sf]);log([ell;p;sf])]
