function[hmin,gcvmin,hh,gcv,trs]=acvll(x,y,n,k,mm,C);
%ACVLL  estimation of optimal bandwidth of local - linear estimator
%       by using Akaike's penalizing function (Akaike's information criterion)
%
%[hmin,acvmin]=acvll(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('ACV');
title('Akaike error function for LL estimator');
figure(C+1);
plot(hh,trs,'b');
title('Akaike penalization function for LL estimator');
end;
