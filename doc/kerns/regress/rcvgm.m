function[hmin,gcvmin,hh,gcv,trs]=rcvgm(x,y,n,k,mm,C);
%RCVGM  estimation of optimal bandwidth for Gasser - Mueller estimator
%       by using Rice's penalizing function
%
%[hmin,acvmin]=rcvgm(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('RCV');
title('Rice error function for GM estimator');
figure(C+1);
plot(hh,trs,'b');
title('Rice penalizing function for GM estimator');
end;
