function[hmin,gcvmin,hh,gcv,trs]=fcvpch(x,y,n,k,mm,C);
%FCVPCH  estimation of optimal bandwidth of Pristley - Chao estimator
%        by using full cross-validation
%
%[hmin,acvmin]=fcvpch(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('FCV');
title('Full cross-validation for PCH estimator');
figure(C+1);
plot(hh,trs,'b');
title('FCV penalizing function for PCH estimator');
end;
