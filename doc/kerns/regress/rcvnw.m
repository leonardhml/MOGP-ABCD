function[hmin,gcvmin,hh,gcv,trs]=rcvnw(x,y,n,k,mm,C);
%RCVNW  estimation of optimal bandwidth for Nadaraya - Watson estimator
%       by using Rice's penalizing function
%
%[hmin,acvmin]=rcvnw(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('RCV');
title('Rice error function for NW estimator');
figure(C+1);
plot(hh,trs,'b');
title('Rice penalizing function for NW estimator');
end;
