function[hmin,gcvmin,hh,gcv,trs]=fcvgm(x,y,n,k,mm,C);
%FCVGM  estimation of optimal bandwidth of Gasser - Mueller estimator
%       by using full cross-validation
%
%[hmin,acvmin]=fcvgm(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('FCV');
title('Full cross-validation for GM estimator');
figure(C+1);
plot(hh,trs,'b');
title('FCV penalizing function for GM estimator');
end;
