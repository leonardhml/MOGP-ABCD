function[hmin,gcvmin,hh,gcv,trs]=gcvpch(x,y,n,k,mm,C);
%GCVPCH  estimation of optimal bandwidth of Pristley - Chao estimator
%        by using generalized cross-validation
%
%[hmin,acvmin]=gcvpch(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('GCV');
title('Generalized cross-validation for PCH estimator');
figure(C+1);
plot(hh,trs,'b');
title('GCV penalizing function for PCH estimator');
end;
