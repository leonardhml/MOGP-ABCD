function[hmin,gcvmin,hh,gcv,trs]=gcvgm(x,y,n,k,mm,C);
%GCVGM  estimation of optimal bandwidth of Gasser - Mueller estimator
%       by using generalized cross-validation
%
%[hmin,acvmin]=gcvgm(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('GCV');
title('Generalized cross-validation for GM estimator');
figure(C+1);
plot(hh,trs,'b');
title('GCV penalizing function for GM estimator');
end;
