function[hmin,gcvmin,hh,gcv,trs]=scvnw(x,y,n,k,mm,C);
%SCVNW  estimation of optimal bandwidth for Nadaraya - Watson estimator
%       by using Shibata's penalizing function
%
%[hmin,acvmin]=scvnw(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('SCV');
title('Shibata error function for NW estimator');
figure(C+1);
plot(hh,trs,'b');
title('Shibata penalizing function for NW estimator');
end;