function[hmin,gcvmin,hh,gcv,trs]=fpecvgm(x,y,n,k,mm,C);
%FPECVGM  estimation of optimal bandwidth of Gasser - Mueller estimator
...
xlabel('h');
ylabel('FPECV');
title('FPECV error function for GM estimator');
figure(C+1);
plot(hh,trs,'b');
title('FPECV penalizing function for GM estimator');
end;
