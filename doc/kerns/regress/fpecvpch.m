function[hmin,gcvmin,hh,gcv,trs]=fpecvpch(x,y,n,k,mm,C);
%FPECVPCH  estimation of optimal bandwidth of Pristley - Chao estimator
%          by using Finite Prediction Error function
%
%[hmin,acvmin]=fpecvgm(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('FPECV');
title('FPECV error function for PCH estimator');
figure(C+1);
plot(hh,trs,'b');
title('FPECV penalizing function for PCH estimator');
end;
