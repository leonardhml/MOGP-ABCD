function[hmin,gcvmin,hh,gcv,trs]=rcvll(x,y,n,k,mm,C);
%RCVLL  estimation of optimal bandwidth for local - linear estimator
%       by using Rice's penalizing function
%
%[hmin,acvmin]=rcvll(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('RCV');
title('Rice error function for LL estimator');
figure(C+1);
plot(hh,trs,'b');
title('Rice penalizing function for LL estimator');
end;
