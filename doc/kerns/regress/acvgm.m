function[hmin,gcvmin,hh,gcv,trs]=acvgm(x,y,n,k,mm,C);
%ACVGM  estimation of optimal bandwidth of Gasser - Mueller estimator
%       by using Akaike's penalizing function (Akaike's information criterion)
%
%[hmin,acvmin]=acvgm(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('ACV');
title('Akaike error function for GM estimator');
figure(C+1);
plot(hh,trs,'b');
title('Akaike penalizing function for GM estimator');
end;
