function[hmin,gcvmin,hh,gcv,trs]=fpecvll(x,y,n,k,mm,C);
%FPECVLL  estimation of optimal bandwidth of local - linear estimator
%         by using Finite Prediction Error function
%
%[hmin,acvmin]=fpecvll(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('FPECV');
title('FPECV error function for LL estimator');
figure(C+1);
plot(hh,trs,'b');
title('FPECV penalizing function for LL estimator');
end;
