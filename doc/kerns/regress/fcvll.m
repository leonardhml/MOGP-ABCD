function[hmin,gcvmin,hh,gcv,trs]=fcvll(x,y,n,k,mm,C)
%FCVLL  estimation of optimal bandwidth of local - linear estimator
%       by using full cross-validation
%
%[hmin,acvmin]=fcvll(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('FCV');
title('Full cross-validation for LL estimator');
figure(C+1);
plot(hh,trs,'b');
title('FCV penalizing function for LL estimator');
end;
