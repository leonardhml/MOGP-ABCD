function[hmin,gcvmin,hh,gcv,trs]=acvpch(x,y,n,k,mm,C);
%ACVPCH  estimation of optimal bandwidth of Gasser - Mueller estimator
%        by using Akaike's penalizing function (Akaike's information criterion)
%
%[hmin,acvmin]=acvpch(x,y,n,k,m,C) 
...
xlabel('h');
ylabel('ACV');
title('Akaike error function for PCH estimator');
figure(C+1);
plot(hh,trs,'b');
title('Akaike penalization function for PCH estimator');
end;
